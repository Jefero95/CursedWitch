...
const Home: NextPage = () => {
    ...
    return (
      <Container maxW={"1200px"}>
        <Flex direction={"column"} h={"100vh"} justifyContent={"center"} alignItems={"center"}>
          <Heading my={"40px"}>Welcome to Cursed Witch</Heading>
          <ConnectWallet />
        </Flex>
      </Container>
    );
  ...
  return (
    <Container maxW={"1200px"}>
      <SimpleGrid columns={2} spacing={10}>
        <Card p={5}>
          ...
          <SimpleGrid columns={2} spacing={10}>
            ...
            <Box>
              <Text fontSize={"big"} fontWeight={"bold"}>$ELIXIR Balance:</Text>
                {rewardBalance && (
      ...
      <Card p={5} my={10}>
        <Heading mb={"30px"}>Equiped Potions:</Heading>
